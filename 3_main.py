...
with st.sidebar:
    ...
    <div style="text-align: center; margin-bottom: 30px;">
        ...
        <h2 style="font-size: 18px;">Recomposição da Aprendizagem</h2>
    </div>
...
# Introdução
st.markdown("""
Bem-vindo ao **CESB Analytic**, uma plataforma especializada para análise e recomposição da aprendizagem.
Esta ferramenta foi desenvolvida para fornecer insights valiosos sobre o domínio de 
habilidades matemáticas e auxiliar na formação de grupos de intervenção pedagógica.
""")
